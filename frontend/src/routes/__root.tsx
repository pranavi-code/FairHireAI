...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FairHireAI — Placement-readiness feedback for students" },
      {
        name: "description",
        content:
          "FairHireAI gives students evidence-backed placement-readiness feedback for self-improvement. Not a hiring decision or ranking system.",
      },
      { name: "author", content: "FairHireAI" },
      { property: "og:title", content: "FairHireAI — Placement-readiness feedback for students" },
      {
